import{n as d,b as l,H as i}from"./iframe-CilUHbPg.js";import{T as h}from"./TwoFactorAuthEnabledRequirement-DGKO9F_E.js";import"./index-r8ZA1smB.js";import"./RequirementItem-BpYQ3BtQ.js";import"./LockTwoTone-Dbgm935X.js";const R={title:"Governance/Data Access Request Flow/Requirements/TwoFactorAuthEnabledRequirement",component:h,parameters:{stack:"mock"},argTypes:{isAuthenticated:{control:{type:"boolean"}}},args:{isAuthenticated:!0}};function m(u){return[d.get(`${l}/auth/v1/2fa`,()=>{const p={status:u?"ENABLED":"DISABLED"};return i.json(p,{status:200})})]}const e={parameters:{msw:{handlers:[m(!0)]}}},t={parameters:{msw:{handlers:[m(!1)]}}};var a,r,s;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  parameters: {
    msw: {
